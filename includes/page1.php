        ...
        <div id="wrapper">
            ...
            <header>
                ...
                <div id="mainTitleWithLogo">
                	<h4>mainTitleWithLogo | h4 | #999666 | padding 10px 10px 10px 10px | border 5px solid black | <span style="color: blue;">p.1 - float (The Old Way) without clear</span></h4>	
