        ...
        <div id="wrapper">
            ...
            <header>
                ...
                <div id="mainTitleWithLogo">
                	<h4>mainTitleWithLogo | h4 | #999666 | padding 10px 10px 10px 10px | border 5px solid black | <span style="color: blue;">p.2 - float (The Old Way) with clear (nav class after-box)</span></h4>	
