    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <header>
                ...
                <div id="mainTitleWithLogo" class="clearfix">
                	<h4>mainTitleWithLogo | h4 | #999666 | padding 10px 10px 10px 10px | border 5px solid black | <span style="color: blue;">p.3 - float (The Old Way) with clear (div id mainTitleWithLogo class clearfix)</span></h4>	
