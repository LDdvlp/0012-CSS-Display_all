        ...
        <div id="wrapper">
            ...
            <header>
                ...
                <div class="flex-container">
                	<h4 class="flex-item">mainTitleWithLogo | h4 | #999666 | padding 10px 10px 10px 10px | border 5px solid black | <span style="color: blue;">p.6 - flexbox</span></h4>	
                    <div class="flex-item">
