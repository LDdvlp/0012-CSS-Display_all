...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline">
	...
	<?php endif; ?>
	<div class="userdata">
		<!-- floating-box class added -->      
		<div id="form-login-username" class="control-group floating-box">
        	<div class="controls" >
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
						...
						-->
						<input id="modlgn-username" type="text" name="username" class="input-small" tabindex="0" size="30" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME'); ?>" />
					</div>
              	<!-- 
				<?php //else : ?>
      	...
      	<!-- floating-box class added -->
		<div id="form-login-password" class="control-group floating-box">
          	<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
                      	<!--
		...
		<?php //if (count($twofactormethods) > 1) : ?>
      	<div id="form-login-submit" class="control-group floating-box">
			<div class="controls">
       	...
       	floating-box class added
		<div id="form-login-secretkey" class="control-group floating-box">
       		<div class="controls">
				<?php //if (!$params->get('usetext')) : ?>
		...
		<div id="form-login-submit" class="control-group floating-box">
			<div class="controls">
				<button type="submit" tabindex="0" name="Submit" class="btn aquitconcept-buttons"><?php //echo JText::_('JLOGIN'); ?><span style="vertical-align:undefined;" class="fa fa-caret-right"></span></button>
              	<!--
              	<button type="submit" tabindex="0" name="Submit" class="btn btn-primary login-button"><?php //echo JText::_('JLOGIN'); ?><span style="vertical-align:undefined;" class="fa fa-caret-right"></span></button>
				-->
