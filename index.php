        ...
        <div id="wrapper">
            ...
            <header>
                ...
                <div id="mainTitleWithLogo">
                	<h4>mainTitleWithLogo | h4 | #999666 | padding 10px 10px 10px 10px | border 5px solid black | <span style="color: blue;">Stucture initiale</span></h4>	
                    <div id="withLogo">
                    	<h5>withLogo | h5 | #999666 | padding 10px 10px 10px 10px | border 5px solid blue</h5>	
                    </div>
                    <div id="mainTitle">
                    	<h5>mainTitle | h5 | #999666 | padding 10px 10px 10px 10px | border 5px solid green</h5>	
                    </div>
                </div>
                ...
                <nav>
                    ...
                    <ul>
                        <li><a href="includes/page0.php">Run To The Display</a></li>
                    </ul>
